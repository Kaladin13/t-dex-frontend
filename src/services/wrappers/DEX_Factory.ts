...
export function loadSortedAddressesAndCoins(slice: Slice) {
    ...
    return { $$type: 'SortedAddressesAndCoins' as const, lower: _lower, higher: _higher, lowerCoins: _lowerCoins, higherCoins: _higherCoins };
}
...
export function storeAmmPool$Data(src: AmmPool$Data) {
    return (builder: Builder) => {
        ...
        if (src.jettonContent !== null && src.jettonContent !== undefined) { b_0.storeBit(true).storeRef(src.jettonContent); } else { b_0.storeBit(false); }
    };
}
...
export function loadAmmPool$Data(slice: Slice) {
    ...
    return { $$type: 'AmmPool$Data' as const, leftVault: _leftVault, rightVault: _rightVault, leftSideReserve: _leftSideReserve, rightSideReserve: _rightSideReserve, totalSupply: _totalSupply, jettonContent: _jettonContent };
}
...
export function storeLiquidityDepositContract$Data(src: LiquidityDepositContract$Data) {
    return (builder: Builder) => {
        ...
        if (src.leftAdditionalParams !== null && src.leftAdditionalParams !== undefined) { b_1.storeBit(true); b_1.store(storeAdditionalParams(src.leftAdditionalParams)); } else { b_1.storeBit(false); }
        if (src.rightAdditionalParams !== null && src.rightAdditionalParams !== undefined) { b_1.storeBit(true); b_1.store(storeAdditionalParams(src.rightAdditionalParams)); } else { b_1.storeBit(false); }
        b_0.storeRef(b_1.endCell());
    };
}
...
export function loadLiquidityDepositContract$Data(slice: Slice) {
    ...
    return { $$type: 'LiquidityDepositContract$Data' as const, leftVault: _leftVault, rightVault: _rightVault, leftSideAmount: _leftSideAmount, rightSideAmount: _rightSideAmount, depositor: _depositor, contractId: _contractId, status: _status, leftAdditionalParams: _leftAdditionalParams, rightAdditionalParams: _rightAdditionalParams };
}
...
export function loadTupleLiquidityDepositContract$Data(source: TupleReader) {
    ...
    const _leftAdditionalParams = _leftAdditionalParams_p ? loadTupleAdditionalParams(_leftAdditionalParams_p) : null;
    const _rightAdditionalParams_p = source.readTupleOpt();
    const _rightAdditionalParams = _rightAdditionalParams_p ? loadTupleAdditionalParams(_rightAdditionalParams_p) : null;
    return { $$type: 'LiquidityDepositContract$Data' as const, leftVault: _leftVault, rightVault: _rightVault, leftSideAmount: _leftSideAmount, rightSideAmount: _rightSideAmount, depositor: _depositor, contractId: _contractId, status: _status, leftAdditionalParams: _leftAdditionalParams, rightAdditionalParams: _rightAdditionalParams };
}
...
export function loadJettonNotifyWithActionRequest(slice: Slice) {
    ...
    const _proof = sc_0;
    return { $$type: 'JettonNotifyWithActionRequest' as const, queryId: _queryId, amount: _amount, sender: _sender, eitherBit: _eitherBit, actionOpcode: _actionOpcode, actionPayload: _actionPayload, proofType: _proofType, proof: _proof };
}
...
export function loadJettonVault$Data(slice: Slice) {
    ...
    return { $$type: 'JettonVault$Data' as const, jettonMaster: _jettonMaster, jettonWallet: _jettonWallet };
}
...
export function storeSwapIn(src: SwapIn) {
    return (builder: Builder) => {
        ...
        if (src.multihopInfo !== null && src.multihopInfo !== undefined) { b_2.storeBit(true); b_2.store(storeMultihopInfo(src.multihopInfo)); } else { b_2.storeBit(false); }
...
export function loadSwapIn(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 2888784440) { throw Error('Invalid prefix'); }
    const _amount = sc_0.loadCoins();
    ...
    return { $$type: 'SwapIn' as const, amount: _amount, receiver: _receiver, params: _params, multihopInfo: _multihopInfo };
}
...
export function loadMultihopInfo(slice: Slice) {
    ...
    return { $$type: 'MultihopInfo' as const, leftVault: _leftVault, rightVault: _rightVault, outVault: _outVault };
}
...
export function storePayoutFromPool(src: PayoutFromPool) {
    return (builder: Builder) => {
        ...
        b_0.storeCoins(src.amount);
        b_0.storeAddress(src.receiver);
        if (src.payloadToForward !== null && src.payloadToForward !== undefined) { b_0.storeBit(true).storeRef(src.payloadToForward); } else { b_0.storeBit(false); }
    };
}

export function loadPayoutFromPool(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 122649184) { throw Error('Invalid prefix'); }
    const _otherVault = sc_0.loadAddress();
    const _amount = sc_0.loadCoins();
    const _receiver = sc_0.loadAddress();
    const _payloadToForward = sc_0.loadBit() ? sc_0.loadRef() : null;
    return { $$type: 'PayoutFromPool' as const, otherVault: _otherVault, amount: _amount, receiver: _receiver, payloadToForward: _payloadToForward };
}
...
export function loadLiquidityDeposit(slice: Slice) {
    ...
    return { $$type: 'LiquidityDeposit' as const, depositor: _depositor, contractId: _contractId, leftAmount: _leftAmount, rightAmount: _rightAmount, leftAdditionalParams: _leftAdditionalParams, rightAdditionalParams: _rightAdditionalParams };
}
...
export function storeLiquidityWithdrawParameters(src: LiquidityWithdrawParameters) {
    return (builder: Builder) => {
        ...
        b_0.storeAddress(src.receiver);
        if (src.liquidityWithdrawPayload !== null && src.liquidityWithdrawPayload !== undefined) { b_0.storeBit(true).storeRef(src.liquidityWithdrawPayload); } else { b_0.storeBit(false); }
    };
}
...
export function loadLiquidityWithdrawParameters(slice: Slice) {
    ...
    return { $$type: 'LiquidityWithdrawParameters' as const, leftAmountMin: _leftAmountMin, rightAmountMin: _rightAmountMin, timeout: _timeout, receiver: _receiver, liquidityWithdrawPayload: _liquidityWithdrawPayload };
}
...
export function storeLiquidityWithdrawViaBurnNotification(src: LiquidityWithdrawViaBurnNotification) {
    return (builder: Builder) => {
        const b_0 = builder;
...
export function loadLiquidityWithdrawViaBurnNotification(slice: Slice) {
    ...
    return { $$type: 'LiquidityWithdrawViaBurnNotification' as const, queryId: _queryId, amount: _amount, sender: _sender, responseDestination: _responseDestination, forwardPayload: _forwardPayload };
}
...
export function storeTupleLiquidityWithdrawViaBurnNotification(source: LiquidityWithdrawViaBurnNotification) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.queryId);
    builder.writeNumber(source.amount);
    builder.writeAddress(source.sender);
...
export function loadMintViaJettonTransferInternal(slice: Slice) {
    ...
    const _forwardTonAmount = sc_0.loadCoins();
    const _forwardPayload = sc_0;
    return { $$type: 'MintViaJettonTransferInternal' as const, queryId: _queryId, amount: _amount, sender: _sender, sendAllTonsInNotifyFlag: _sendAllTonsInNotifyFlag, responseDestination: _responseDestination, forwardTonAmount: _forwardTonAmount, forwardPayload: _forwardPayload };
}
...
export function loadPartHasBeenDeposited(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 3886237535) { throw Error('Invalid prefix'); }
    const _depositor = sc_0.loadAddress();
    const _amount = sc_0.loadCoins();
    const _additionalParams = loadAdditionalParams(sc_0);
    return { $$type: 'PartHasBeenDeposited' as const, depositor: _depositor, amount: _amount, additionalParams: _additionalParams };
}
...
export function storeAdditionalParams(src: AdditionalParams) {
    return (builder: Builder) => {
        ...
        if (src.payloadOnSuccess !== null && src.payloadOnSuccess !== undefined) { b_0.storeBit(true).storeRef(src.payloadOnSuccess); } else { b_0.storeBit(false); }
        if (src.payloadOnFailure !== null && src.payloadOnFailure !== undefined) { b_0.storeBit(true).storeRef(src.payloadOnFailure); } else { b_0.storeBit(false); }
    };
}
...
export function loadAdditionalParams(slice: Slice) {
    ...
    return { $$type: 'AdditionalParams' as const, minAmountToDeposit: _minAmountToDeposit, lpTimeout: _lpTimeout, payloadOnSuccess: _payloadOnSuccess, payloadOnFailure: _payloadOnFailure };
}
...
export function storeSwapStep(src: SwapStep) {
    return (builder: Builder) => {
        ...
        if (src.nextStep !== null && src.nextStep !== undefined) { b_0.storeBit(true).storeRef(src.nextStep); } else { b_0.storeBit(false); }
    };
}
...
export function loadSwapStep(slice: Slice) {
    ...
    return { $$type: 'SwapStep' as const, pool: _pool, minAmountOut: _minAmountOut, nextStep: _nextStep };
}
...
export function storeSwapParameters(src: SwapParameters) {
    return (builder: Builder) => {
        ...
        if (src.payloadOnSuccess !== null && src.payloadOnSuccess !== undefined) { b_0.storeBit(true).storeRef(src.payloadOnSuccess); } else { b_0.storeBit(false); }
        if (src.payloadOnFailure !== null && src.payloadOnFailure !== undefined) { b_0.storeBit(true).storeRef(src.payloadOnFailure); } else { b_0.storeBit(false); }
        if (src.nextStep !== null && src.nextStep !== undefined) { b_0.storeBit(true); b_0.store(storeSwapStep(src.nextStep)); } else { b_0.storeBit(false); }
    };
}
...
export function loadSwapParameters(slice: Slice) {
    ...
    return { $$type: 'SwapParameters' as const, isExactOutType: _isExactOutType, cashbackAddress: _cashbackAddress, desiredAmount: _desiredAmount, timeout: _timeout, payloadOnSuccess: _payloadOnSuccess, payloadOnFailure: _payloadOnFailure, nextStep: _nextStep };
}
...
export function loadLiquidityDepositInitData(slice: Slice) {
    ...
    const _contractId = sc_0.loadUintBig(64);
    return { $$type: 'LiquidityDepositInitData' as const, otherVault: _otherVault, otherAmount: _otherAmount, contractId: _contractId };
}
...
export function storeLiquidityDepositEitherAddress(src: LiquidityDepositEitherAddress) {
    return (builder: Builder) => {
        ...
        if (src.initData !== null && src.initData !== undefined) { b_0.storeBit(true); b_0.store(storeLiquidityDepositInitData(src.initData)); } else { b_0.storeBit(false); }
    };
}
...
export function loadLiquidityDepositEitherAddress(slice: Slice) {
    ...
    return { $$type: 'LiquidityDepositEitherAddress' as const, eitherBit: _eitherBit, liquidityDepositContract: _liquidityDepositContract, initData: _initData };
}
...
export function loadLPDepositPart(slice: Slice) {
    ...
    const _additionalParams = loadAdditionalParams(sc_0);
    return { $$type: 'LPDepositPart' as const, liquidityDepositContractData: _liquidityDepositContractData, additionalParams: _additionalParams };
}
...
export function loadSwapRequestTon(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 1770830344) { throw Error('Invalid prefix'); }
    const _amount = sc_0.loadCoins();
...
export function loadAddLiquidityPartTon(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 457393782) { throw Error('Invalid prefix'); }
    const _amountIn = sc_0.loadCoins();
    const _liquidityDepositContractData = loadLiquidityDepositEitherAddress(sc_0);
    const sc_1 = sc_0.loadRef().beginParse();
    const _additionalParams = loadAdditionalParams(sc_1);
    return { $$type: 'AddLiquidityPartTon' as const, amountIn: _amountIn, liquidityDepositContractData: _liquidityDepositContractData, additionalParams: _additionalParams };
}
...
export function loadReturnJettonsViaJettonTransfer(slice: Slice) {
    ...
    const _forwardTonAmount = sc_0.loadCoins();
    const _forwardPayload = sc_0;
    return { $$type: 'ReturnJettonsViaJettonTransfer' as const, queryId: _queryId, amount: _amount, destination: _destination, responseDestination: _responseDestination, customPayload: _customPayload, forwardTonAmount: _forwardTonAmount, forwardPayload: _forwardPayload };
}
...
export function loadUnexpectedJettonNotification(slice: Slice) {
    ...
    const _sender = sc_0.loadAddress();
    const _forwardPayload = sc_0;
    return { $$type: 'UnexpectedJettonNotification' as const, queryId: _queryId, amount: _amount, sender: _sender, forwardPayload: _forwardPayload };
}
...
export function loadTEP89DiscoveryResult(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 2048026621) { throw Error('Invalid prefix'); }
    ...
    return { $$type: 'TEP89DiscoveryResult' as const, discoveryId: _discoveryId, expectedJettonWallet: _expectedJettonWallet, actualJettonWallet: _actualJettonWallet, action: _action };
}
...
export function loadTEP89DiscoveryProxy$Data(slice: Slice) {
    ...
    const _action = sc_0.loadRef();
    const _discoveryId = sc_0.loadUintBig(64);
    return { $$type: 'TEP89DiscoveryProxy$Data' as const, jettonMaster: _jettonMaster, discoveryRequester: _discoveryRequester, expectedJettonWallet: _expectedJettonWallet, action: _action, discoveryId: _discoveryId };
}
...
export function loadLPJettonWallet$Data(slice: Slice) {
    ...
    return { $$type: 'LPJettonWallet$Data' as const, balance: _balance, owner: _owner, minter: _minter };
}
...
export function loadJettonTransferInternal(slice: Slice) {
    ...
    const _forwardTonAmount = sc_0.loadCoins();
    const _forwardPayload = sc_0;
    return { $$type: 'JettonTransferInternal' as const, queryId: _queryId, amount: _amount, sender: _sender, sendAllTonsInNotifyFlag: _sendAllTonsInNotifyFlag, responseDestination: _responseDestination, forwardTonAmount: _forwardTonAmount, forwardPayload: _forwardPayload };
}
...
export function loadLPWithdrawViaJettonBurn(slice: Slice) {
    ...
    const _responseDestination = sc_0.loadMaybeAddress();
    const _customPayload = sc_0.loadBit() ? sc_0.loadRef() : null;
    return { $$type: 'LPWithdrawViaJettonBurn' as const, queryId: _queryId, amount: _amount, responseDestination: _responseDestination, customPayload: _customPayload };
}
...
export function loadLPWithdrawNotification(slice: Slice) {
    ...
    return { $$type: 'LPWithdrawNotification' as const, queryId: _queryId, amount: _amount, sender: _sender, responseDestination: _responseDestination, forwardPayload: _forwardPayload };
}
...
export function loadMerkleProof(slice: Slice) {
    ...
    const _content = sc_0.loadRef();
    return { $$type: 'MerkleProof' as const, tag: _tag, hash: _hash, depth: _depth, content: _content };
}
...
export function loadMerkleUpdate(slice: Slice) {
    ...
    return { $$type: 'MerkleUpdate' as const, tag: _tag, _prevHash: __prevHash, newHash: _newHash, _oldDepth: __oldDepth, _newDepth: __newDepth, _prevState: __prevState, newState: _newState };
}
...
export function loadBlockHeader(slice: Slice) {
    ...
    const _extra = sc_0;
    return { $$type: 'BlockHeader' as const, _info: __info, _valueFlow: __valueFlow, stateUpdate: _stateUpdate, extra: _extra };
}
...
export function loadMcBlockExtra(slice: Slice) {
    ...
    return { $$type: 'McBlockExtra' as const, _unusedBits: __unusedBits, shardHashes: _shardHashes, _unusedRemaining: __unusedRemaining };
}

export function loadTupleMcBlockExtra(source: TupleReader) {
    const __unusedBits = source.readBigNumber();
    const _shardHashes = Dictionary.loadDirect(Dictionary.Keys.Int(32), Dictionary.Values.Cell(), source.readCellOpt());
...
export function storeTupleMcBlockExtra(source: McBlockExtra) {
    ...
    builder.writeCell(source.shardHashes.size > 0 ? beginCell().storeDictDirect(source.shardHashes, Dictionary.Keys.Int(32), Dictionary.Values.Cell()).endCell() : null);
...
export function loadShardDescr(slice: Slice) {
    ...
    return { $$type: 'ShardDescr' as const, _unusedBits: __unusedBits, rootHash: _rootHash, _remaining: __remaining };
}
...
export function loadBlockId(slice: Slice) {
    ...
    return { $$type: 'BlockId' as const, workchain: _workchain, shard: _shard, seqno: _seqno, rootHash: _rootHash, fileHash: _fileHash };
}
...
export function loadStateProof(slice: Slice) {
    ...
    return { $$type: 'StateProof' as const, mcBlockSeqno: _mcBlockSeqno, shardBitLen: _shardBitLen, mcBlockHeaderProof: _mcBlockHeaderProof, shardBlockHeaderProof: _shardBlockHeaderProof, shardChainStateProof: _shardChainStateProof };
}
...
export function storeAugHashmapLookupResult(src: AugHashmapLookupResult) {
    return (builder: Builder) => {
        const b_0 = builder;
        if (src.valueWithExtra !== null && src.valueWithExtra !== undefined) { b_0.storeBit(true).storeRef(src.valueWithExtra.asCell()); } else { b_0.storeBit(false); }
...
export function loadAugHashmapLookupResult(slice: Slice) {
    ...
    return { $$type: 'AugHashmapLookupResult' as const, valueWithExtra: _valueWithExtra, found: _found };
}
...
export function loadParseHashmapLabelResult(slice: Slice) {
    ...
    return { $$type: 'ParseHashmapLabelResult' as const, self: _self, label: _label, labelLength: _labelLength };
}
...
export function loadLPDepositParams(slice: Slice) {
    ...
    const _depositor = sc_1.loadAddress();
    const _contractId = sc_1.loadUintBig(64);
    return { $$type: 'LPDepositParams' as const, firstVault: _firstVault, secondVault: _secondVault, firstAmount: _firstAmount, secondAmount: _secondAmount, depositor: _depositor, contractId: _contractId };
}
...
export function storeAddressesRequest(src: AddressesRequest) {
    return (builder: Builder) => {
        ...
        if (src.second !== null && src.second !== undefined) { b_0.storeBit(true); b_0.store(storeRequest(src.second)); } else { b_0.storeBit(false); }
        const b_1 = new Builder();
        if (src.third !== null && src.third !== undefined) { b_1.storeBit(true); b_1.store(storeRequest(src.third)); } else { b_1.storeBit(false); }
...
export function loadAddressesRequest(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 2958248825) { throw Error('Invalid prefix'); }
    ...
    return { $$type: 'AddressesRequest' as const, responseAddress: _responseAddress, first: _first, second: _second, third: _third, forwardPayload: _forwardPayload };
}
...
export function loadAddressResponse(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 3167933154) { throw Error('Invalid prefix'); }
    const _first = sc_0.loadAddress();
    const _second = sc_0.loadMaybeAddress();
    const _third = sc_0.loadMaybeAddress();
    const _forwardPayload = sc_0.loadBit() ? sc_0.loadRef() : null;
    return { $$type: 'AddressResponse' as const, first: _first, second: _second, third: _third, forwardPayload: _forwardPayload };
}
...
async function Factory_init() {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    const __system = Cell.fromHex('');
...
export const Factory_errors = {
    ...
    56834: { message: "JettonVault: Expected and Actual wallets are not equal or gas for action is not enough" },
...
const Factory_types: ABIType[] = [
    ...
    {"name":"SortedAddresses","header":null,"fields":[{"name":"lower","type":{"kind":"simple","type":"address","optional":false}},{"name":"higher","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"SortedAddressesAndCoins","header":null,"fields":[{"name":"lower","type":{"kind":"simple","type":"address","optional":false}},{"name":"higher","type":{"kind":"simple","type":"address","optional":false}},{"name":"lowerCoins","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"higherCoins","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
    {"name":"AmmPool$Data","header":null,"fields":[{"name":"leftVault","type":{"kind":"simple","type":"address","optional":false}},{"name":"rightVault","type":{"kind":"simple","type":"address","optional":false}},{"name":"leftSideReserve","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"rightSideReserve","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"totalSupply","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"jettonContent","type":{"kind":"simple","type":"cell","optional":true}}]},
    {"name":"LiquidityDepositContract$Data","header":null,"fields":[{"name":"leftVault","type":{"kind":"simple","type":"address","optional":false}},{"name":"rightVault","type":{"kind":"simple","type":"address","optional":false}},{"name":"leftSideAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"rightSideAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"depositor","type":{"kind":"simple","type":"address","optional":false}},{"name":"contractId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"status","type":{"kind":"simple","type":"uint","optional":false,"format":3}},{"name":"leftAdditionalParams","type":{"kind":"simple","type":"AdditionalParams","optional":true}},{"name":"rightAdditionalParams","type":{"kind":"simple","type":"AdditionalParams","optional":true}}]},
    {"name":"JettonNotifyWithActionRequest","header":1935855772,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"sender","type":{"kind":"simple","type":"address","optional":false}},{"name":"eitherBit","type":{"kind":"simple","type":"bool","optional":false}},{"name":"actionOpcode","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"actionPayload","type":{"kind":"simple","type":"cell","optional":false}},{"name":"proofType","type":{"kind":"simple","type":"uint","optional":false,"format":8}},{"name":"proof","type":{"kind":"simple","type":"slice","optional":false,"format":"remainder"}}]},
    {"name":"SendViaJettonTransfer","header":260734629,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"destination","type":{"kind":"simple","type":"address","optional":false}},{"name":"responseDestination","type":{"kind":"simple","type":"address","optional":true}},{"name":"customPayload","type":{"kind":"simple","type":"cell","optional":true}},{"name":"forwardTonAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"forwardPayload","type":{"kind":"simple","type":"slice","optional":false,"format":"remainder"}}]},
    {"name":"JettonVault$Data","header":null,"fields":[{"name":"jettonMaster","type":{"kind":"simple","type":"address","optional":false}},{"name":"jettonWallet","type":{"kind":"simple","type":"address","optional":true}}]},
    {"name":"SwapIn","header":2888784440,"fields":[{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"receiver","type":{"kind":"simple","type":"address","optional":false}},{"name":"params","type":{"kind":"simple","type":"SwapParameters","optional":false}},{"name":"multihopInfo","type":{"kind":"simple","type":"MultihopInfo","optional":true}}]},
    {"name":"MultihopInfo","header":null,"fields":[{"name":"leftVault","type":{"kind":"simple","type":"address","optional":false}},{"name":"rightVault","type":{"kind":"simple","type":"address","optional":false}},{"name":"outVault","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"PayoutFromPool","header":122649184,"fields":[{"name":"otherVault","type":{"kind":"simple","type":"address","optional":false}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"receiver","type":{"kind":"simple","type":"address","optional":false}},{"name":"payloadToForward","type":{"kind":"simple","type":"cell","optional":true}}]},
    {"name":"LiquidityDeposit","header":1680571655,"fields":[{"name":"depositor","type":{"kind":"simple","type":"address","optional":false}},{"name":"contractId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"leftAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"rightAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"leftAdditionalParams","type":{"kind":"simple","type":"AdditionalParams","optional":false}},{"name":"rightAdditionalParams","type":{"kind":"simple","type":"AdditionalParams","optional":false}}]},
    {"name":"LiquidityWithdrawParameters","header":null,"fields":[{"name":"leftAmountMin","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"rightAmountMin","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"timeout","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"receiver","type":{"kind":"simple","type":"address","optional":false}},{"name":"liquidityWithdrawPayload","type":{"kind":"simple","type":"cell","optional":true}}]},
    {"name":"LiquidityWithdrawViaBurnNotification","header":2078119902,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"sender","type":{"kind":"simple","type":"address","optional":false}},{"name":"responseDestination","type":{"kind":"simple","type":"address","optional":true}},{"name":"forwardPayload","type":{"kind":"simple","type":"LiquidityWithdrawParameters","optional":false}}]},
    {"name":"MintViaJettonTransferInternal","header":395134233,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"sender","type":{"kind":"simple","type":"address","optional":false}},{"name":"sendAllTonsInNotifyFlag","type":{"kind":"simple","type":"bool","optional":false}},{"name":"responseDestination","type":{"kind":"simple","type":"address","optional":true}},{"name":"forwardTonAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"forwardPayload","type":{"kind":"simple","type":"slice","optional":false,"format":"remainder"}}]},
    {"name":"PartHasBeenDeposited","header":3886237535,"fields":[{"name":"depositor","type":{"kind":"simple","type":"address","optional":false}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"additionalParams","type":{"kind":"simple","type":"AdditionalParams","optional":false}}]},
    {"name":"AdditionalParams","header":null,"fields":[{"name":"minAmountToDeposit","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"lpTimeout","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"payloadOnSuccess","type":{"kind":"simple","type":"cell","optional":true}},{"name":"payloadOnFailure","type":{"kind":"simple","type":"cell","optional":true}}]},
    ...
    {"name":"SwapStep","header":null,"fields":[{"name":"pool","type":{"kind":"simple","type":"address","optional":false}},{"name":"minAmountOut","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"nextStep","type":{"kind":"simple","type":"cell","optional":true}}]},
    {"name":"SwapRequest","header":null,"fields":[{"name":"pool","type":{"kind":"simple","type":"address","optional":false}},{"name":"receiver","type":{"kind":"simple","type":"address","optional":true}},{"name":"params","type":{"kind":"simple","type":"SwapParameters","optional":false}}]},
    {"name":"SwapParameters","header":null,"fields":[{"name":"isExactOutType","type":{"kind":"simple","type":"bool","optional":false}},{"name":"cashbackAddress","type":{"kind":"simple","type":"address","optional":true}},{"name":"desiredAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"timeout","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"payloadOnSuccess","type":{"kind":"simple","type":"cell","optional":true}},{"name":"payloadOnFailure","type":{"kind":"simple","type":"cell","optional":true}},{"name":"nextStep","type":{"kind":"simple","type":"SwapStep","optional":true}}]},
    {"name":"LiquidityDepositInitData","header":null,"fields":[{"name":"otherVault","type":{"kind":"simple","type":"address","optional":false}},{"name":"otherAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"contractId","type":{"kind":"simple","type":"uint","optional":false,"format":64}}]},
    {"name":"LiquidityDepositEitherAddress","header":null,"fields":[{"name":"eitherBit","type":{"kind":"simple","type":"bool","optional":false}},{"name":"liquidityDepositContract","type":{"kind":"simple","type":"address","optional":true}},{"name":"initData","type":{"kind":"simple","type":"LiquidityDepositInitData","optional":true}}]},
    {"name":"LPDepositPart","header":null,"fields":[{"name":"liquidityDepositContractData","type":{"kind":"simple","type":"LiquidityDepositEitherAddress","optional":false}},{"name":"additionalParams","type":{"kind":"simple","type":"AdditionalParams","optional":false}}]},
    {"name":"SwapRequestTon","header":1770830344,"fields":[{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"action","type":{"kind":"simple","type":"SwapRequest","optional":false}}]},
    {"name":"AddLiquidityPartTon","header":457393782,"fields":[{"name":"amountIn","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"liquidityDepositContractData","type":{"kind":"simple","type":"LiquidityDepositEitherAddress","optional":false}},{"name":"additionalParams","type":{"kind":"simple","type":"AdditionalParams","optional":false}}]},
    {"name":"ReturnJettonsViaJettonTransfer","header":260734629,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"destination","type":{"kind":"simple","type":"address","optional":false}},{"name":"responseDestination","type":{"kind":"simple","type":"address","optional":true}},{"name":"customPayload","type":{"kind":"simple","type":"cell","optional":true}},{"name":"forwardTonAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"forwardPayload","type":{"kind":"simple","type":"slice","optional":false,"format":"remainder"}}]},
    {"name":"UnexpectedJettonNotification","header":1935855772,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"sender","type":{"kind":"simple","type":"address","optional":false}},{"name":"forwardPayload","type":{"kind":"simple","type":"slice","optional":false,"format":"remainder"}}]},
    {"name":"TonVault$Data","header":null,"fields":[{"name":"admin","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"TEP89DiscoveryResult","header":2048026621,"fields":[{"name":"discoveryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"expectedJettonWallet","type":{"kind":"simple","type":"address","optional":false}},{"name":"actualJettonWallet","type":{"kind":"simple","type":"address","optional":true}},{"name":"action","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"TEP89DiscoveryProxy$Data","header":null,"fields":[{"name":"jettonMaster","type":{"kind":"simple","type":"address","optional":false}},{"name":"discoveryRequester","type":{"kind":"simple","type":"address","optional":false}},{"name":"expectedJettonWallet","type":{"kind":"simple","type":"address","optional":false}},{"name":"action","type":{"kind":"simple","type":"cell","optional":false}},{"name":"discoveryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}}]},
    {"name":"LPJettonWallet$Data","header":null,"fields":[{"name":"balance","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"minter","type":{"kind":"simple","type":"address","optional":false}}]},
    ...
    {"name":"ParsedExotic","header":null,"fields":[{"name":"data","type":{"kind":"simple","type":"slice","optional":false}},{"name":"isExotic","type":{"kind":"simple","type":"bool","optional":false}}]},
    {"name":"MerkleProof","header":null,"fields":[{"name":"tag","type":{"kind":"simple","type":"uint","optional":false,"format":8}},{"name":"hash","type":{"kind":"simple","type":"uint","optional":false,"format":256}},{"name":"depth","type":{"kind":"simple","type":"uint","optional":false,"format":16}},{"name":"content","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"MerkleUpdate","header":null,"fields":[{"name":"tag","type":{"kind":"simple","type":"uint","optional":false,"format":8}},{"name":"_prevHash","type":{"kind":"simple","type":"uint","optional":false,"format":256}},{"name":"newHash","type":{"kind":"simple","type":"uint","optional":false,"format":256}},{"name":"_oldDepth","type":{"kind":"simple","type":"uint","optional":false,"format":16}},{"name":"_newDepth","type":{"kind":"simple","type":"uint","optional":false,"format":16}},{"name":"_prevState","type":{"kind":"simple","type":"cell","optional":false}},{"name":"newState","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"BlockHeader","header":null,"fields":[{"name":"_info","type":{"kind":"simple","type":"cell","optional":false}},{"name":"_valueFlow","type":{"kind":"simple","type":"cell","optional":false}},{"name":"stateUpdate","type":{"kind":"simple","type":"cell","optional":false}},{"name":"extra","type":{"kind":"simple","type":"slice","optional":false,"format":"remainder"}}]},
    {"name":"McBlockExtra","header":null,"fields":[{"name":"_unusedBits","type":{"kind":"simple","type":"uint","optional":false,"format":17}},{"name":"shardHashes","type":{"kind":"dict","key":"int","keyFormat":32,"value":"cell","valueFormat":"ref"}},{"name":"_unusedRemaining","type":{"kind":"simple","type":"slice","optional":false,"format":"remainder"}}]},
    {"name":"ShardDescr","header":null,"fields":[{"name":"_unusedBits","type":{"kind":"simple","type":"uint","optional":false,"format":196}},{"name":"rootHash","type":{"kind":"simple","type":"uint","optional":false,"format":256}},{"name":"_remaining","type":{"kind":"simple","type":"slice","optional":false,"format":"remainder"}}]},
    {"name":"TreeNode","header":null,"fields":[{"name":"leftChild","type":{"kind":"simple","type":"cell","optional":false}},{"name":"rightChild","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"TwoCells","header":null,"fields":[{"name":"first","type":{"kind":"simple","type":"cell","optional":false}},{"name":"second","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"BlockId","header":null,"fields":[{"name":"workchain","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"shard","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"seqno","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"rootHash","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"fileHash","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
    {"name":"StateProof","header":null,"fields":[{"name":"mcBlockSeqno","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"shardBitLen","type":{"kind":"simple","type":"uint","optional":false,"format":8}},{"name":"mcBlockHeaderProof","type":{"kind":"simple","type":"cell","optional":false}},{"name":"shardBlockHeaderProof","type":{"kind":"simple","type":"cell","optional":false}},{"name":"shardChainStateProof","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"AugHashmapLookupResult","header":null,"fields":[{"name":"valueWithExtra","type":{"kind":"simple","type":"slice","optional":true}},{"name":"found","type":{"kind":"simple","type":"bool","optional":false}}]},
    {"name":"ParseHashmapLabelResult","header":null,"fields":[{"name":"self","type":{"kind":"simple","type":"slice","optional":false}},{"name":"label","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"labelLength","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
    {"name":"AmmPoolParams","header":null,"fields":[{"name":"firstVault","type":{"kind":"simple","type":"address","optional":false}},{"name":"secondVault","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"LPDepositParams","header":null,"fields":[{"name":"firstVault","type":{"kind":"simple","type":"address","optional":false}},{"name":"secondVault","type":{"kind":"simple","type":"address","optional":false}},{"name":"firstAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"secondAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"depositor","type":{"kind":"simple","type":"address","optional":false}},{"name":"contractId","type":{"kind":"simple","type":"uint","optional":false,"format":64}}]},
    {"name":"JettonVaultParams","header":null,"fields":[{"name":"jettonMaster","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"Request","header":null,"fields":[{"name":"requestId","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"request","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"AddressesRequest","header":2958248825,"fields":[{"name":"responseAddress","type":{"kind":"simple","type":"address","optional":true}},{"name":"first","type":{"kind":"simple","type":"Request","optional":false}},{"name":"second","type":{"kind":"simple","type":"Request","optional":true}},{"name":"third","type":{"kind":"simple","type":"Request","optional":true}},{"name":"forwardPayload","type":{"kind":"simple","type":"cell","optional":true}}]},
    {"name":"AddressResponse","header":3167933154,"fields":[{"name":"first","type":{"kind":"simple","type":"address","optional":false}},{"name":"second","type":{"kind":"simple","type":"address","optional":true}},{"name":"third","type":{"kind":"simple","type":"address","optional":true}},{"name":"forwardPayload","type":{"kind":"simple","type":"cell","optional":true}}]},
...
const Factory_getters: ABIGetter[] = [
    {"name":"ammPoolAddr","methodId":93983,"arguments":[{"name":"params","type":{"kind":"simple","type":"AmmPoolParams","optional":false}}],"returnType":{"kind":"simple","type":"address","optional":false}},
    {"name":"lpDepositAddr","methodId":100234,"arguments":[{"name":"params","type":{"kind":"simple","type":"LPDepositParams","optional":false}}],"returnType":{"kind":"simple","type":"address","optional":false}},
    {"name":"jettonVaultAddr","methodId":94286,"arguments":[{"name":"params","type":{"kind":"simple","type":"JettonVaultParams","optional":false}}],"returnType":{"kind":"simple","type":"address","optional":false}},
]

export const Factory_getterMapping: { [key: string]: string } = {
    'ammPoolAddr': 'getAmmPoolAddr',
    'lpDepositAddr': 'getLpDepositAddr',
    'jettonVaultAddr': 'getJettonVaultAddr',
}

const Factory_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"empty"}},
    {"receiver":"internal","message":{"kind":"typed","type":"AddressesRequest"}},
]
...
export class Factory implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | AddressesRequest) {
        
        let body: Cell | null = null;
        if (message === null) {
            body = new Cell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'AddressesRequest') {
            body = beginCell().store(storeAddressesRequest(message)).endCell();
        }
    ...
    async getAmmPoolAddr(provider: ContractProvider, params: AmmPoolParams) {
        const builder = new TupleBuilder();
        builder.writeTuple(storeTupleAmmPoolParams(params));
        const source = (await provider.get('ammPoolAddr', builder.build())).stack;
        const result = source.readAddress();
        return result;
    }
    
    async getLpDepositAddr(provider: ContractProvider, params: LPDepositParams) {
        const builder = new TupleBuilder();
        builder.writeTuple(storeTupleLPDepositParams(params));
        const source = (await provider.get('lpDepositAddr', builder.build())).stack;
        const result = source.readAddress();
        return result;
    }
    
    async getJettonVaultAddr(provider: ContractProvider, params: JettonVaultParams) {
        const builder = new TupleBuilder();
        builder.writeTuple(storeTupleJettonVaultParams(params));
        const source = (await provider.get('jettonVaultAddr', builder.build())).stack;
        const result = source.readAddress();
        return result;
    }
